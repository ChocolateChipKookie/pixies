...
#include "PlanktonPixies.h"
#include "../util/math.h"
#include <glm/glm.hpp>
PlanktonPixies::PlanktonPixies(kki::Texture* background, size_t count, float max_speed, float acceleration, float noise_scale, bool random_start)
...
PlanktonPixies::PlanktonPixies(kki::Texture* background, const PlanktonPixies::Setup& setup)
    :   PlanktonPixies(background, setup.count, setup.max_speed, setup.acceleration, setup.noise_scale, setup.random_start)
{}

void PlanktonPixies::update(size_t i)
{
